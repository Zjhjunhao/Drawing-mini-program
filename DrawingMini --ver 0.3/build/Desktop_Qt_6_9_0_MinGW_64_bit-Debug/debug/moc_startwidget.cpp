...
#include "../../../../DrawingMini--ver 0.5/startwidget.h"
...
void StartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->newCanvasRequested(); break;
        case 1: _t->openFileRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StartWidget::*)()>(_a, &StartWidget::newCanvasRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartWidget::*)()>(_a, &StartWidget::openFileRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void StartWidget::newCanvasRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void StartWidget::openFileRequested()
{
